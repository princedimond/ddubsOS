{ pkgs, ... }: {
  services.polybar = {
    ...
    settings = {
      ...
      "bar/Codeboy" = {
        ...
        modules-right = "filesystem pulseaudio xkeyboard memory cpu network-base wlan date";
  ...
  # Only start polybar when running an X11 bspwm session.
  # Prevents polybar from starting under Hyprland/Wayland sessions.
